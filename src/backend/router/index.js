...
adminRouter.get('/api/sections/:param', auth.jwtAuth, function(req, res) {
	if (req.params.param == 'existing') section.getExistingSectionsList(req, res);

	if (req.params.param == 'possible') section.getPossibleSectiosList(req, res);
});
...
adminRouter.put('/api/media', auth.jwtAuth, function(req, res) {
