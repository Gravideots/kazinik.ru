...
@connect(state => ({
    eventPageAsyncData: state.event.get('eventPageAsyncData'),
    eventPageAsyncError: state.event.get('eventPageAsyncError'),
    eventPageAsyncLoading: state.event.get('eventPageAsyncLoading')
  }))
export default class Event extends Component {
    ...
    render() {
        ...
        var date = { year: 'short', month: 'short', day: 'short' };
            ...
            <div className='EventPage row'>
                <div className='col l6'>
                    ...
                    <div className='col l12'>
                        ...
                        <div className='col l3'>
                            <Button onClick={()=>{this.openDropDown()}} text='Купить билет' data='modal1' className='modal-trigger'/>
                                ...
                                <div className="modal-content">
                                    <div className='row'>
                                        {buttons.map((button, i)=>{
                                            return <div key={i} className='col'><Button  onClick={()=>{this.goTo(button.Url)}} ><Image src={ button.img } alt={ button.Name }/></Button></div>
                                        })}
                                    </div>
                                </div>
                            </div>
