...
export const OPEN_CONTENT_EDITOR = 'OPEN_CONTENT_EDITOR';
...
export const EDIT_MEDIA_CONTENT_START = 'EDIT_MEDIA_CONTENT_START';
export const EDIT_MEDIA_CONTENT_ERROR = 'EDIT_MEDIA_CONTENT_ERROR';
export const EDIT_MEDIA_CONTENT_SUCCESS = 'EDIT_MEDIA_CONTENT_SUCCESS';
...
export function openContentEditor(data) {
	return {type: OPEN_CONTENT_EDITOR, data};
}
...
function editMediaStart() {
	return {type: EDIT_MEDIA_CONTENT_START};
}
function editMediaSuccess() {
	return {type: EDIT_MEDIA_CONTENT_SUCCESS};
}
function editMediaError() {
	return {type: EDIT_MEDIA_CONTENT_ERROR};
}
