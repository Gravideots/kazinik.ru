...
export default class Admin extends Component {
    ...
    render() {
      ...
      if (content) {
        if (content.PosibleSections) { return <SectionManagement content={ content.PosibleSections } dispatch={ dispatch } /> ;}
        if (content.NewSection) { return <CreateNewSection content={ content } dispatch={ dispatch } />; }
        if (content.Section) { return <EditSection content={ content.Section } dispatch={ dispatch } /> ;}
      } else { return <AdminStart /> ;}
      ...
      if (element.exists && element.id) {
        actions = (
          <div className='card-action'>
                <a
              href='#'
              onClick={ (event) => { this.selectSectionToEdit(event, element.id); } }
            >
                        Редактировать
            </a>
        ...
        actions = (
          <div className='card-action'>
            <a
              href='#'
              onClick={ (event) => { this.selectSectionToCreate(event, element); } }
            >
                        Создать
            </a>
          </div>
