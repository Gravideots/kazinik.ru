...
export default class Input extends Component {
	...
	render() {
		...
		return (
			<div className='Input'>
				{icon}
				<input type={type} className={'input ' + inputName } data-position={position} data-tooltip='Обязательное поле' placeholder={placeholder} value={this.state.value} onChange={this.handleChange} required={!!validate}/>
			</div>
		);
	}
}
