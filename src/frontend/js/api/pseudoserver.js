export const MainPage = {
    ...
    slideShowPartners: [

        {
            Active: true,
            URL: 'https://ya.ru',
            BackgroundImage: 'assets/img/logos/obectiv.png',
        },
        {
            Active: true,
            URL: 'https://ya.ru',
            BackgroundImage: 'assets/img/logos/dozhd.png',
        },
        {
            Active: true,
            URL: 'https://ya.ru',
            BackgroundImage: 'assets/img/logos/mayak.png',
        },
        {
            Active: true,
            URL: 'https://ya.ru',
            BackgroundImage: 'assets/img/logos/orpheus.jpg',
        },
        {
            Active: true,
            URL: 'https://ya.ru',
            BackgroundImage: 'assets/img/logos/serdozhd.png',
        },
        {
            Active: true,
            URL: 'https://ya.ru',
            BackgroundImage: 'assets/img/logos/gds.png',
        },
        {
            Active: true,
            URL: 'https://ya.ru',
...
export const NotePage = {
    Date: new Date(),
    Author: 'Великолепный Иван Иванович',
    Title: 'Как жить в Австрии и не умерерть от тоски по родине',
    SubTitle: '(На самом деле нет)',
