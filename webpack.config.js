...
const entry = [path.join(paths.javascript, 'index.js')];
...
if (IS_DEVELOPMENT) {
  ...
  // Don't emmit build when there was an error while compiling No assets are
  // emitted that include errors
  new webpack.NoEmitOnErrorsPlugin(),
  // Webpack dashboard plugin
  new DashboardPlugin());

  // In development we add 'react-hot-loader' for .js/.jsx files Check rules in
  // config.js
  rules[0]
    .use
    .unshift('react-hot-loader/webpack');
